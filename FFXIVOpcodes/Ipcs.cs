namespace FFXIVOpcodes.Global
{
    ...
    */
    enum ServerZoneIpcType : ushort
    {
        ...
        ExamineSearchInfo = 0x038D, // updated 7.45h
        Examine = 0x036C, // updated 7.45h
        ActorCast = 0x00E1, // updated 7.45h
        CurrencyCrystalInfo = 0x00CE, // updated 7.45h
        InitZone = 0x0246, // updated 7.45h
        WeatherChange = 0x0122, // updated 7.45h
        PlayerSpawn = 0x03CA, // updated 7.45h
        ActorSetPos = 0x013D, // updated 7.45h
        PrepareZoning = 0x008E, // updated 7.45h
        ContainerInfo = 0x03A3, // updated 7.45h
        ItemInfo = 0x03A7, // updated 7.45h
        PlaceFieldMarker = 0x011C, // updated 7.45h
        PlaceFieldMarkerPreset = 0x01EB, // updated 7.45h
        EffectResult = 0x00F2, // updated 7.45h
        EventStart = 0x00BC, // updated 7.45h
        EventFinish = 0x023C, // updated 7.45h
        DesynthResult = 0x03BE, // updated 7.45h
        FreeCompanyInfo = 0x02DA, // updated 7.45h
        FreeCompanyDialog = 0x0234, // updated 7.45h
        MarketBoardSearchResult = 0x0295, // updated 7.45h
        MarketBoardItemListingCount = 0x02EF, // updated 7.45h
        MarketBoardItemListingHistory = 0x02EF, // updated 7.45h
        MarketBoardItemListing = 0x01C2, // updated 7.45h
        MarketBoardPurchase = 0x0271, // updated 7.45h
        UpdateInventorySlot = 0x037E, // updated 7.45h
        InventoryActionAck = 0x0124, // updated 7.45h
        InventoryTransaction = 0x011A, // updated 7.45h
        InventoryTransactionFinish = 0x025F, // updated 7.45h
        ResultDialog = 0x03D1, // updated 7.45h
        RetainerInformation = 0x028D, // updated 7.45h
        NpcSpawn = 0x01EB, // updated 7.45h
        ItemMarketBoardInfo = 0x031A, // updated 7.45h
        ObjectSpawn = 0x00BB, // updated 7.45h
        EffectResultBasic = 0x0139, // updated 7.45h
        Effect = 0x0348, // updated 7.45h
        StatusEffectList = 0x01DF, // updated 7.45h
        StatusEffectList2 = 0x03D5, // updated 7.45h
        StatusEffectList3 = 0x03B0, // updated 7.45h
        ...
        AirshipExplorationResult = 0x009A, // updated 7.45h
        ...
        EventPlay = 0x00CF, // updated 7.45h
        ...
        EventPlay64 = 0x0083, // updated 7.45h
        EventPlay128 = 0x0093, // updated 7.45h
        EventPlay255 = 0x022A, // updated 7.45h

        EnvironmentControl = 0x0110, // updated 7.45h
        IslandWorkshopSupplyDemand = 0x02AD, // updated 7.45h
        Logout = 0x03E7, // updated 7.45h
    };
    ...
    */
    enum ClientZoneIpcType : ushort
    {
        ...
        SetSearchInfoHandler = 0x02AA, // updated 7.45h
        MarketBoardPurchaseHandler = 0x0317, // updated 7.45h
        InventoryModifyHandler = 0x0267, // updated 7.45h
