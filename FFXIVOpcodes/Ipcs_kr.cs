namespace FFXIVOpcodes.KR
{
    ...
    */
    enum ServerZoneIpcType : ushort
    {
        ...
        AirshipExplorationResult = 0x02B7, // 7.4
        AirshipStatus = 0x0205, // 7.4
        AirshipStatusList = 0x036C, // 7.4
        AirshipTimers = 0x0227, // 7.4
        ...
        SubmarineExplorationResult = 0x02C2, // 7.4
        SubmarineProgressionStatus = 0x02BF, // 7.4
        SubmarineStatusList = 0x0268, // 7.4
        SubmarineTimers = 0x0316, // 7.4
